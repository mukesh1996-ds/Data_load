...
setup(
  ...
  packages = ['from load_data import load_csv'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/mukesh1996-ds/Data_load/archive/refs/tags/v_01.tar.gz',  # I explain this later on
